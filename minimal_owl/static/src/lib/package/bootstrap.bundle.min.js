...
!(function (t, e) {
    typeof exports === "object" && typeof module !== "undefined"
        ...
        ? define(e)
        : ((t = typeof globalThis !== "undefined" ? globalThis : t || self).bootstrap =
              e());
})(this, function () {
    const t = new Map(),
        e = {
        ...
        l = (t) =>
            ...
            Boolean(t.classList.contains("disabled")) ||
            (void 0 !== t.disabled
                ? t.disabled
        ...
        g = (t, e = [], i = t) => (typeof t === "function" ? t(...e) : i),
        _ = (t, e, n = !0) => {
    ...
    function De(t) {
        return me(t) && xe(t).position !== "fixed" ? t.offsetParent : null;
    }
    function $e(t) {
        for (var e = fe(t), i = De(t); i && ke(i) && xe(i).position === "static"; )
            i = De(i);
        return i &&
            (ue(i) === "html" || (ue(i) === "body" && xe(i).position === "static"))
            ? e
            : i ||
                  (function (t) {
                      var e = /firefox/i.test(Ae());
                      if (/Trident/i.test(Ae()) && me(t) && xe(t).position === "fixed")
                          return null;
                      var i = Se(t);
                      for (
                          ge(i) && (i = i.host);
    ...
    function We(t) {
        var e,
            ...
            p = r.y,
            m = void 0 === p ? 0 : p,
            g = typeof h === "function" ? h({x: f, y: m}) : {x: f, y: m};
        (f = g.x), (m = g.y);
    ...
    function Je(t, e) {
        ...
        void 0 === e && (e = []);
        var n = Ge(t),
            s = n === ((i = t.ownerDocument) == null ? void 0 : i.body),
            o = fe(n),
    ...
    function ii(t, e) {
        ...
        var i = e,
            ...
            m = i.padding,
            g = void 0 === m ? 0 : m,
            _ = Pe(typeof g !== "number" ? g : Me(g, Qt)),
            b = u === Jt ? Zt : Jt,
            v = t.rects.popper,
            y = t.elements[p ? b : u],
            w = (function (t, e, i, n) {
                ...
                if (A) {
                    ...
                    if (a) {
                        var J,
                            ...
                            nt = et + g[Z],
                            st = et - g[tt],
                            ot = [zt, Vt].indexOf(_) !== -1,
                            rt = (J = x == null ? void 0 : x[w]) != null ? J : 0,
            ...
            for (const e of t)
                if (e === "click")
                    ...
                    N.on(this._element, t, this._config.selector, (t) => {
                        ...
                        (e._activeTrigger[t.type === "focusin" ? os : ss] = !0),
                            e._enter();
                    }),
                        N.on(this._element, i, this._config.selector, (t) => {
                            const e = this._initializeOnDelegatedTarget(t);
                            (e._activeTrigger[t.type === "focusout" ? os : ss] =
